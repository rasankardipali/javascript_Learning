...
arrayOfNumbers.unshift(0,13,55,6,8);
console.log(arrayOfNumbers);
...
console.log(array_numbers);
let splicedElements1 =  array_numbers.splice(4,2);
console.log(array_numbers);
let splicedElements2 =  array_numbers.splice(4,0,12,34);
console.log(array_numbers);

console.log("============ splice() ===========");
let array_numbers0 = [1, 3, 7, 8, 9, 3];
console.log(array_numbers0);
 ...
 array_numbers0.splice(2, 1, 22, 44, 66);
 console.log(array_numbers0);
